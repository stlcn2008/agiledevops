 ...
 */
Ext.define('AgileDevOpsClient.view.main.Main', {
            ...
            items: [
                {
                    ...
                    cls: 'sencha-logo',
                    html: '<div class="main-logo"><img src="resources/images/agiledevops.png">Agile DevOps</div>',
                    width: 250
                },
                {
                    margin: '0 0 0 8',
                ...
                },
                {
                    ...
                    src: 'resources/images/user-profile/tony.png'
                }
            ]
        },
        {
